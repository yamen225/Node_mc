...
handlers.index = function(data, callback){
  ...
  if(data.method == 'get'){
    ...
    var templateData = {
      'head.title' : 'Uptime Monitorinf - Made simple',
      'head.description' : 'We provide a simple uptime running for http/https sites, if your site went down you will be notified by a text.',
...
handlers.sessionDeleted = function (data, callback) {
    ...
    if (data.method == 'get') {
        ...
        var templateData = {
            ...
            'head.description': 'yopu have been logged out from your account',
            'body.class': 'sessionDeleted'
        };
        // Read in the sessionDeleted template as a string
